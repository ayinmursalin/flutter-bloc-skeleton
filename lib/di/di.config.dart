...
import 'package:bloc_skeleton/data/local/app_preferences.dart' as _i5;
import 'package:bloc_skeleton/data/remote/interceptors/auth_interceptor.dart'
    as _i3;
import 'package:bloc_skeleton/data/remote/services/example_service.dart' as _i7;
import 'package:bloc_skeleton/data/repository/example_repository.dart' as _i8;
import 'package:bloc_skeleton/data/repository/example_repository_impl.dart'
    as _i13;
import 'package:bloc_skeleton/di/local_module.dart' as _i10;
import 'package:bloc_skeleton/di/network_module.dart' as _i11;
import 'package:bloc_skeleton/di/repository_module.dart' as _i12;
import 'package:bloc_skeleton/di/usecase_module.dart' as _i14;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i7.ExampleService>(
        networkModule.exampleService(gh<_i6.Dio>()));
    gh.singleton<_i8.ExampleRepository>(repositoryModule.exampleRepository);
    gh.factory<_i9.GetPostUseCase>(
        () => useCaseModule.getPostUseCase(gh<_i8.ExampleRepository>()));
    return this;
  }
}
